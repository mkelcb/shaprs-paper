...
write.table(simDF, paste0(outputName,"_SNPs"), sep = " ", row.names = F, col.names = T, quote = FALSE)

write.table(t(SNP_effects), outputName, sep = " ", row.names = F, col.names = F, quote = FALSE)
print(paste("written effect sizes to",outputName))
