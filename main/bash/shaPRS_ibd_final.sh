...
ukbbQCkeeplist=$commonDataLoc$'ukbb_hq_keeplist.txt' # Headerless file, col1: TeamID (for imputed data) col2: 
...
# 1) Apply the preprocessing shaPRS step ( already done)a
