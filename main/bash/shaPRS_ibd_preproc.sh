...
# convert the UC raw PLINK sumstats into my sumstats format
...
if(A1[ $2 ] != 0) {
print $1"\t"$3"\t"$2"\t"A1[ $2 ]"\t"A2[ $2 ]"\tX\t"$5"\t"$6"\t"$9"\t"avgNumIndis 
}} }
' OFS='\t' $ukbb32K$'.bim' $bootStrapLoc$foldFam$'PLINK.qassoc' > $bootStrapLoc$foldFam$'PLINK.ss'
head $bootStrapLoc$foldFam$'PLINK.ss'


# test QC on this if it still fails 99% of the time
arguments='/nfs/users/nfs_m/mk23/scripts/LDpred2_QC.R '$baseLDpredLoc$'/ '$bootStrapLoc$foldFam$'PLINK.ss '$shaPRSPre$pheno$'_'$i$'_PLINK '$binPheno
/nfs/team152/mk23/software/R_X_farm/R-3.6.1/bin/Rscript $arguments

# arguments
baseLoc= "/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/shaprs/raw/ldpred2//"   # the location of the per-chrom LDref panels and the HapMap3 map file, used to 
sumstatsLoc="/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/GWAS_f1PLINK.ss"
outLoc="/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/shaPRSPre/UC_1_PLINK"
binary_outcome= "1" =="1"



#  "out of 845626 QC excluded 845625, and kept 1 SNPs, written to: /lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/shaPRSPre/UC_1_PLINK"
# So this fails even the original Subtypes.... Need to check back for WHY it hasn't failed for LDpred2_v2 ???


###############

avgNumIndis=$(wc -l < "$bootStrapLoc$foldFam".fam)
arguments='/nfs/users/nfs_m/mk23/scripts/LDpred2_auto_v2.R '$baseLDpredLoc$' '$bootStrapLoc$foldFam$'PLINK.qassoc '$NCORES$' '$avgNumIndis$' '$shaPRSPre$' '$pheno$'_'$i$'_PLINK '$bootStrapLoc$foldFam$'TEST_hapmap3.bed'
/nfs/team152/mk23/software/R_X_farm/R-3.6.1/bin/Rscript $arguments


baseLoc="/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/shaprs/raw/ldpred2/"          
sumstatsLoc="/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/GWAS_f1PLINK.qassoc"
NCORES=15
n_eff = 13257
outLoc= "/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/shaPRSPre/"    
outName="UC_1_PLINK"  
testSetLoc="/lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/GWAS_f1TEST_hapmap3.bed"

print(paste0("out of ", nrow(info_snp), " QC excluded ", sum(is_bad), ", and kept ",length(info_snp$rsid.ss[!is_bad])," SNPs, written to: ",outLoc ))

"out of 955918 QC excluded 86, and kept 955832 SNPs, written to: /lustre/scratch123/hgi/mdt1/projects/crohns/mk23/0Thesis/ibd/data/gwas3_uc/bootstrap/shaPRSPre/"
