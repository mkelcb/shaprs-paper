####################################################
#
# UKBB Simulation studies: generating phenotypes, running association / PRS analyses and evaluating results
#
#########################
# static vars
