...
# 3) run MTAG/SHAPRS
RUN_MTAG $newResultsLoc$'gwas3_cd/CD_MTAG' $newResultsLoc$'gwas3_cd/gwas3_cd_hm3' $newResultsLoc$'gwas3_uc/gwas3_uc_hm3'

RUN_MTAG $newResultsLoc$'gwas3_uc/UC_MTAG' $newResultsLoc$'gwas3_uc/gwas3_uc_hm3' $newResultsLoc$'gwas3_cd/gwas3_cd_hm3'


shaPRS_fixed $newResultsLoc$'gwas3_cd/CD_SHAPRS' $newResultsLoc$'gwas3_cd/gwas3_cd_hm3' $newResultsLoc$'gwas3_uc/gwas3_uc_hm3' $rho

shaPRS_fixed $newResultsLoc$'gwas3_uc/UC_SHAPRS' $newResultsLoc$'gwas3_uc/gwas3_uc_hm3' $newResultsLoc$'gwas3_cd/gwas3_cd_hm3' $rho



#grep "rs7517847" $newResultsLocCohort${ibd_gwas[$j-1]}'_raw'

#grep "rs7517847" $newResultsLoc$'gwas3_cd/gwas3_cd_hm3'
#chr     pos     SNP     A1      A2      Freq1.Hapmap    b       se      p       N
#1       67681669        rs7517847       G       T       0.423282        -0.353103       0.0285179       3.27851e-35     10874

#rs7517847	1	67681669	-0.136001	0.0280205	G	T	-0.353103	0.0285179	G	T 

#grep "rs7517847" $newResultsLoc$'gwas3_cd/CD_SHAPRS_lFDR_meta_SNP_lFDR'

# awk 'FNR <= NR { { if ( FNR > 1 && $2 < 0.5) { maxSNP=maxSNP+1 } } } END {print "numSNP lFDR <1\t"maxSNP;}'  $newResultsLoc$'gwas3_cd/CD_SHAPRS_lFDR_meta_SNP_lFDR'

#awk 'FNR <= NR { { if ( FNR > 1 && $2 < 0.5) { print $0 } } } '  $newResultsLoc$'gwas3_cd/CD_SHAPRS_lFDR_meta_SNP_lFDR' > $newResultsLoc$'gwas3_cd/CD_SHAPRS_lFDR_meta_SNP_lFDR_05'
#wc -l $newResultsLoc$'gwas3_cd/CD_SHAPRS_lFDR_meta_SNP_lFDR_05'
# 1,123,683


head $newResultsLoc$'gwas3_cd/CD_MTAG_mtag'
head $newResultsLoc$'gwas3_uc/UC_MTAG_mtag'


wc -l $newResultsLoc$'gwas3_cd/CD_SHAPRS_shaprs'
wc -l $newResultsLoc$'gwas3_uc/UC_SHAPRS_shaprs'

wc -l $newResultsLoc$'gwas3_uc/UC_SHAPRS_shaprsMerged_combined'
wc -l $newResultsLoc$'gwas3_cd/CD_SHAPRS_shaprsMerged_combined'



# 5) PRS-CS (wait until cluster job finishes)
PRSCS_allChroms $newResultsLoc$'gwas3_cd/CD_MTAG_mtag' "gwas3_cd_mtag" $newScratchLoc $crossAncestryLoc
PRSCS_allChroms $newResultsLoc$'gwas3_cd/CD_SHAPRS_shaprs' "gwas3_cd_shaprs" $newScratchLoc $crossAncestryLoc

PRSCS_allChroms $newResultsLoc$'gwas3_uc/UC_MTAG_mtag' "gwas3_uc_mtag" $newScratchLoc $crossAncestryLoc
PRSCS_allChroms $newResultsLoc$'gwas3_uc/UC_SHAPRS_shaprs' "gwas3_uc_shaprs" $newScratchLoc $crossAncestryLoc


# 6) Build PRS
Concat_BuildPRS 'gwas3_cd_mtag' $crossAncestryLoc $ibdDataLoc$'gwas1/ibd_all' $ibdCommonDataScratch$'gwas1/all_found.fam' $newResultsLoc
Concat_BuildPRS 'gwas3_cd_shaprs' $crossAncestryLoc $ibdDataLoc$'gwas1/ibd_all' $ibdCommonDataScratch$'gwas1/all_found.fam' $newResultsLoc

Concat_BuildPRS 'gwas3_uc_mtag' $crossAncestryLoc $ibdDataLoc$'gwas2/ibd_all' $ibdCommonDataScratch$'gwas2/all_found.fam' $newResultsLoc
Concat_BuildPRS 'gwas3_uc_shaprs' $crossAncestryLoc $ibdDataLoc$'gwas2/ibd_all' $ibdCommonDataScratch$'gwas2/all_found.fam' $newResultsLoc




## 7) Evaluate
Evaluate_PRS $newResultsLoc$'PRSProfiles/gwas3_cd_mtag_PRSCS/gwas3_cd_mtag_PRSCS_all.sscore' $newResultsLoc$'gwas3_cd_mtag' '0' # correlation_sq 0.0908 /  AUC 0.687
Evaluate_PRS $newResultsLoc$'PRSProfiles/gwas3_cd_shaprs_PRSCS/gwas3_cd_shaprs_PRSCS_all.sscore' $newResultsLoc$'gwas3_cd_shaprs' '0' # correlation_sq  0.0838 / AUC 0.679

Evaluate_PRS $newResultsLoc$'PRSProfiles/gwas3_uc_mtag_PRSCS/gwas3_uc_mtag_PRSCS_all.sscore' $newResultsLoc$'gwas3_uc_mtag' '0' # correlation_sq  0.044 /  AUC 0.625
Evaluate_PRS $newResultsLoc$'PRSProfiles/gwas3_uc_shaprs_PRSCS/gwas3_uc_shaprs_PRSCS_all.sscore' $newResultsLoc$'gwas3_uc_shaprs' '0' # correlation_sq  0.0433 /  AUC 0.623


CD_MTAG             OLD_DATA    NEWWAVE  DIFF
correlation_sq      0.0828      0.0908   +0.008
AUC                 0.677       0.687    +0.01

CD_shaPRS           OLD_DATA    NEWWAVE  DIFF  
correlation_sq      0.0757      0.0838   +0.0081
AUC                 0.672       0.679    +0.007

UC_MTAG             OLD_DATA    NEWWAVE  DIFF  
correlation_sq      0.0388      0.044	 +0.0052
AUC                 0.617       0.625    +0.008

UC_shaPRS           OLD_DATA    NEWWAVE  DIFF  
correlation_sq      0.0387      0.0433   +0.0046
AUC                 0.619       0.623    +0.004
...
head $ibdDataLoc$'gwas1/ibd_all.fam' # 
tail $ibdDataLoc$'gwas1/ibd_all.fam' # 
head $ibdDataLoc$'gwas2/ibd_all.fam' # 
tail $ibdDataLoc$'gwas2/ibd_all.fam' # 
