...
# performPRSCS_custom $crossAncestryResults$pheno'_sumstats_meta_QC_CSxsubset_PRSCS' $Neur $eursumstatsLoc$EURPheno$'_validBim' $pheno$shaPRS$'_EUR' $i $NCORES_LDPred2 $prscsrefs'ldblk_ukbb_eur'
...
performPRSCS $rawPRSLoc$'_PRSCS' $Neur $validBim $pheno_name 21 16 "fasz"
